...
private let appLog = OSLog(subsystem: "com.swallpaper.app", category: "ExtensionIPC")
private let appWillTerminateNotificationName = "com.swallpaper.app.wallpaper.appWillTerminate"
private let commandsChangedNotificationName = "com.swallpaper.app.wallpaper.commandsChanged"
...
final class WallpaperExtensionSocketServer: @unchecked Sendable {
    ...
    func notifyExtensionReload() {
        ...
        CFNotificationCenterPostNotification(
            center,
            CFNotificationName("com.swallpaper.app.wallpaper.extensionReload" as CFString),
            nil,
            nil,
            true
        )
